/***
   ...
   *  @description
	*
	*	实验平台：反客STM32F103ZET6核心板 （型号：FK103M5）+ 1.69寸液晶模块（型号：SPI169M1-240*280） 
...
{		
	...
	GPIO_PinRemapConfig(GPIO_Remap_SPI3,ENABLE);					// 重定义SPI3的IO口，使用PB3/PB5分别作为 SCLK/MOSI
...
// SPI3 挂载在APB1总线，总线时钟36MHz	
// 设置为2分频，得到18MHz的SPI驱动时钟
	SPI_InitStructure.SPI_BaudRatePrescaler 	= SPI_BaudRatePrescaler_2;	// 2分频，此时SPI时钟为18MHz
